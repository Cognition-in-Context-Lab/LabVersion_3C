...
#COVID DoG Index and Social Conservatism

ggscatter(omit_df, x = "COVID_DoG_index", y = "Measure5_Social_Index", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Partipcants' Average COVID Delay of Gratification ", ylab = "Social Conservativsm")

#COVID DoG Index and Political Conservatism

ggscatter(omit_df, x = "COVID_DoG_index", y = "Measure5_Political_Index", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Partipcants' Average COVID Delay of Gratification ", ylab = "Political Conservatism ")

ggscatter(omit_df, x = "COVID_DoG_index", y = "Stress_index", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Partipcants' Average COVID Delay of Gratification ", ylab = "Conservative Political Oreintation ")

# COVID DoG Index and Political Orientation, Liberal  

ggscatter(omit_df, x = "COVID_DoG_index", y = "Stress_index", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Partipcants' Average COVID Delay of Gratification ", ylab = "Liberal Political Oreintation ")

# COVID DoG Index and Political Orientation, Conservative  
...
# COVID DoG Index and Political Orientation, Independent 

ggscatter(omit_df, x = "COVID_DoG_index", y = "Stress_index", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Partipcants' Average COVID Delay of Gratification ", ylab = "Independent Political Oreintation ")
