...
##work to debug create_columsn function
...
# make index of delaying (average delaying across categories)
...
```{r}
#create index across all 6 conditions
#create 1 index across social situations/gatherings and 1 index across traveling
#are there data driven differences between the two? E.g. days in one versus months in other
...
#perform tests 3 times:
#1) DoG Index by itself
#2) Index:Expextation of Pandemic
#3) Both indices
```
