...
#HOW DO I PUT GRAPHS ON SAME THINGY??
#are there data driven differences between the two indices (social gatherings and traveling)? E.g. days in one versus months in otherl
...
#doesn't look like there's differences between them, should we run a test? both have similar means? (2.608 v. 3.094) - rounds to 3! average length response was in months
