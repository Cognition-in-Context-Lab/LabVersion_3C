...
##Demographics
#Age
hist(omit_df$Age, breaks = 2)
omit_df$Age
AgeSubset <- omit_df[ which(omit_df$Age < 1000), ]
AgeSubset
hist(AgeSubset$Age)

#Education -- levels not working :(
ggplot(omit_df) +
  geom_bar(aes(x = Education), levels = c("Without high school diploma","High school graduate, no college","High school graduate, some college","Degree from 4 year college","Graduate/professional degree")) +
...
l <- c("Without high school diploma","High school graduate, no college","High school graduate, some college","Degree from 4 year college","Graduate/professional degree")

ggplot(omit_df) +
  geom_bar(aes(x = Education)) +
  scale_x_continuous(labels = l) +
