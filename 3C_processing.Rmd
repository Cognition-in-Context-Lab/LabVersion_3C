...
# Processing. Codebook can be found here: https://docs.google.com/document/d/1P3mAw_hSos0rTQp9I4ItetfMY8JgSN9atARJWKJZeog/edit?usp=sharing
...
## Normalize COVID DoG and Pandemic Length Expextation Data 
...
```{r}
omit_df <- omit_df %>%
  select("id","SmlK","MedK", "LrgK", "MeanK", "logMeanK", "COVID_DoG_index", "logCOVID_DoG_index", "traveling_index", "socialgatherings_index" ,"logPandemicLengthExpect.1",  "Norms_index","FamilyNorm_index", "FriendsNorm_index" ,"StrangerNorm_index", "GCS_index", "IUS_Sum", "Measure2_liberal_Index", "Measure2_cons_Index", "Measure2_liberterian_Index", "Measure5_SECS_Index", "Measure5_Social_Index", "Measure5_Political_Index", "harm_foundation", "fairness_foundation", "ingroup_foundation", "authority_foundation", "purity_foundation",  "Stress_index", "COVIDDanger_ContFears_index", "COVID_econ_fears_index", "COVID_xenophobia", "COVID_checking", "COVID_traumatic_stress", "Impacts_index", "Pathogen_Disgust_index", "Sexual_Disgust_index", "Moral_Disgust_index", "SDRS_Sum_scaled", "Duration..in.seconds.", "Age", "Gender", "Race", "Education", "Occupation", "Nationality", "Ethnicity", "MaritalStatus")   #keep only the variables of interest
